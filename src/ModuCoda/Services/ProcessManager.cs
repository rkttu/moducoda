...
public class ProcessManager : IProcessManager
{
    ...
    public Task<int> StartAsync(string fileName, string arguments = "", string workingDirectory = "", IReadOnlyDictionary<string, string?>? environmentVariables = default, CancellationToken cancellationToken = default)
    {
        ThrowIfDisposed();
        ...
        lock (_lock)
        {
            ...
            {
                foreach (var eachPair in environmentVariables.AsEnumerable())
                    psi.EnvironmentVariables.Add(eachPair.Key, eachPair.Value);
            }
